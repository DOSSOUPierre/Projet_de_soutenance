                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="recettesMenu">
                            <li><a href="general_elements.html">> <span>Ajouter</span></a></li>
                     ...
                     <li><a href="charts.html"><i class="fa fa-bar-chart-o green_color"></i> <span>visualisation </span></a></li>
                     <li>
                       ...
                       <ul class="collapse list-unstyled" id="gestionAdmins">
                            <li><a href="{{ route('register') }}"><span>Créer un compte pour admins</span></a></li>
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                     <a class="dropdown-toggle" data-toggle="dropdown">
                                         ...
                                         <span class="name_user">DOSSOU Pierre</span>
                                     </a>
